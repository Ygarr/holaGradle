...
set CLASSPATH=%APP_HOME%\lib\hola-0.0.1.jar;%APP_HOME%\lib\slf4j-api-1.7.5.jar;%APP_HOME%\lib\joda-time-2.2.jar

@rem Execute hola
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HOLA_OPTS%  -classpath "%CLASSPATH%" hola.HelloWorld %CMD_LINE_ARGS%
